            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('data-models.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Model Management</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('forecast-devices.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Devices Forecast</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('forecast-items.index') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Items Forecast</p>
                                </a>
                            </li>
