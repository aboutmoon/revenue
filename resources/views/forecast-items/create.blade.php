        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Forecast Items Create</h3>
                ...
                <form action="{{ route('forecast-items.store') }}" method="post">
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="datepicker-date-from" class="datepicker">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="datepicker-date-to" class="datepicker">
